...
// Transplant from rc-util: https://github.com/react-component/util/blob/master/src/React/render.ts
...
const { version, render: reactRender, unmountComponentAtNode }: any = fullClone
