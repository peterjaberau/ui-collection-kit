...
export default function Composition({
	...
	return (
		<WithResponsiveViewport>
			<Root testId="root">
        <chakra.div css={bannerStyles.root}>
          <Banner>
            <>banner</>
          </Banner>
        </chakra.div>
            ...
            <Search label="Search" />
				...
				<Main id="main-container" isFixed={isSlotsFixed}>
					<Stack space="space.100" css={headingStyles.root}>
						<Heading size="small">Settings</Heading>
					</Stack>
					<Inline space="space.100" css={contentStyles.root}>
						<DropdownMenu
							shouldRenderToParent
							defaultOpen={defaultMenuIsOpen}
				...
				<Aside isFixed={isSlotsFixed} css={asideStyles.root}>
					<Stack space="space.400" css={asideStyles.content}>
				...
				{isPanelVisible && (
					<Panel>
						<Stack space="space.200" css={panelStyles.content}>
