            ...
            <MenuList>
              ...
              <FlyoutMenuItem>
                ...
                <FlyoutMenuItemContent>
                  ...
                  <ButtonMenuItem
                    elemBefore={
                      <AlignTextLeftIcon label='' color='currentColor' />
                    }
                  >
          ...
          <Stack xcss={contentStyles.root}>
            ...
            <Stack xcss={contentStyles.body} space='space.300'>
              ...
              <Stack space='space.150'>
                <Text as='p'>
                  The Atlassian Design System provides a complete set of UI
                  components, patterns, and guidelines for creating consistent
                  and beautiful user experiences across Atlassian products.
                </Text>
                <Text as='p'>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Commodi labore corporis possimus! Magnam perferendis minus in
                  aliquam facilis enim quaerat. Deleniti dolore magni alias
                  soluta? Molestias aliquam optio modi aliquid!
                </Text>
                <Text as='p'>
                  Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sint
                  quos velit veniam dolore ad aperiam illo odit quisquam
                  ducimus, autem perferendis. Officiis molestias quibusdam
                  inventore voluptatibus id autem labore quia.
                </Text>
              </Stack>
            </Stack>
          </Stack>
              ...
              <TabPanel>
                <Stack xcss={panelStyles.tabPanel} space='space.250'>
                  <Stack space='space.100'>
                    ...
                    <Text>
                      Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                      Cupiditate asperiores omnis doloribus dolorem aperiam
                      consectetur, ipsa corrupti voluptatem praesentium.
                      Perferendis, atque velit voluptatum totam voluptatibus
                      saepe impedit provident minima vel.
                    </Text>
                    <Text>
                      Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                      Doloremque qui provident officiis, veritatis voluptatem et
                      sint eos temporibus distinctio deleniti corrupti vel
                      aliquam at quaerat ipsam reprehenderit recusandae
                      accusantium esse.
                    </Text>
                  </Stack>
                  <Stack space='space.100'>
                    ...
                    <Text>
                      Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                      Hic excepturi sunt laboriosam beatae possimus, velit
                      magnam officiis dicta enim. Maxime tenetur dicta iste
                      tempore expedita ad cum aliquid eos reiciendis!
                    </Text>
                    <Text>
                      Lorem ipsum dolor sit amet consectetur adipisicing elit.
                      Quia tempore quasi magnam recusandae ab eos numquam
                      consequatur dicta error in fuga minima, nemo beatae
                      sapiente voluptatem reprehenderit, cum nesciunt ratione!
                    </Text>
                  </Stack>
                </Stack>
              </TabPanel>
