export const data = {
    ...
    "time-picker": {
        "keyboard": [
            {
                "keys": ["ArrowLeft"],
                "description": "Moves focus to the previous column."
            },
            {
                "keys": ["ArrowRight"],
                "description": "Moves focus to the next column."
            },
            {
                "keys": ["ArrowUp"],
                "description": "Moves focus to the previous cell within the current column."
            },
            {
                "keys": ["ArrowDown"],
                "description": "Moves focus to the next cell within the current column."
            },
            {
                "keys": ["Enter"],
                "description": "Selects the focused hour/minute/second/period and moves focus to the next column."
            },
            {
                "keys": ["Esc"],
                "description": "Closes the time picker without selecting any time."
            }
        ]
    }
}
