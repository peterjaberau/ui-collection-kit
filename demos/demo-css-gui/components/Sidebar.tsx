...
export const Sidebar = () => {
  return (
    ...
    >
      ...
      <NavItem href="/examples/border-radius">Border Radius</NavItem>
      ...
      <NavItem href="/examples/shape-outside">Shape Outside</NavItem>
      ...
      <NavItem href="https://discord.gg/PYF52BEEf3">
        <DiscordIcon />
        Discord
      </NavItem>
    </chakra.nav>
