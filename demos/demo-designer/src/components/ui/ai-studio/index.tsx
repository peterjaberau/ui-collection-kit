...
export const Index = () => {
  return (
    <Flex height="full" direction="column" >
      <HStack minH='14' borderBottomWidth="1px">

      </HStack>

    <Flex flex="1">
      <Box borderRightWidth="1px" hideBelow="lg" flex="1" maxW="sm">
        <ModelParamaters />
      </Box>
      ...
      <Flex direction="column" flex="2">
        <HStack px="4" py="4" justify="space-between" borderBottomWidth="1px">
          <HStack gap="8">
            <HStack gap="4">
              <Text fontWeight="medium" textStyle="sm" hideBelow="sm" m={0}>
                Model
              </Text>
            ...
            <HStack gap="4" hideBelow="md">
              <Text fontWeight="medium" textStyle="sm" m={0}>
                Preset
              </Text>
        ...
        <Box px="4">
          <Flex gap="4">
            ...
            <Stack>
              <Button size="sm"  color="fg.inverted">
                <LuPlay /> Save and run
              </Button>
      ...
      <HStack minH='8' borderTopWidth="1px">
