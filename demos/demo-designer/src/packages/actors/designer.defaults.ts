import {
  ...
  FormLayout,
  FormGrid,
} from "#packages/formily/antd/components"

import { ReactionsSetter } from "#packages/formily/setters"
import { FormItemSwitcher } from "#packages/formily/antd/components/common/FormItemSwitcher"
...
export const registryLocales = {
  "zh-cn": {
    ...
    previews: {
      droppable: "Can drag components",
      addtabpane: "Add pane",
      addcollapsepanel: "Add panel",
      addtablecolumn: "Add column",
      addtablesorthandle: "Add sorting",
      addindex: "Add index",
