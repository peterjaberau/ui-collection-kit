...
): React.PropsWithChildren<ICompositePanelItemProps | any>[] => {
  const items = []
...
const findItem = (
  items: React.PropsWithChildren<ICompositePanelItemProps | any>[],
  key: string | number
) => {
...
export const CompositePanel: React.FC<ICompositePanelProps | any> & {
  Item: React.FC<ICompositePanelItemProps | any>
} = (props) => {
