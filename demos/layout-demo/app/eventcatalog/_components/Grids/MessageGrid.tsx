      ...
      {messages.map((message) => {
        ...
        return (
          <a
            ...
            href={`/docs/${message.collection}/${message.data.id}/${message.data.version}`}
  ...
  return (
    <div>
      ...
      <nav className="mb-4 flex items-center space-x-2 text-sm text-gray-500">
        <a href={'/architecture/domains'} className="hover:text-gray-700 hover:underline flex items-center gap-2">
          <RectangleGroupIcon className="h-4 w-4" />
          Domains
        </a>
        <ChevronRightIcon className="h-4 w-4" />
        <a href={'/architecture/services'} className="hover:text-gray-700 hover:underline flex items-center gap-2">
          <ServerIcon className="h-4 w-4" />
          Services
        </a>
        <ChevronRightIcon className="h-4 w-4" />
        <a href={'/architecture/messages'} className="hover:text-gray-700 hover:underline flex items-center gap-2">
            ...
            <>
              <div className="mb-6 flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  <a
                    href={`/visualiser/domains/${urlParams.domainId}`}
                  ...
                  <a
                    href={`/docs/domains/${urlParams.domainId}`}
              ...
              <>
                ...
                <div className="flex items-center gap-2 mb-8">
                  ...
                  <div className="flex gap-2 ml-auto">
                    <a
                      href={`/visualiser/services/${urlParams.serviceId}`}
                    ...
                    <a
                      href={`/docs/services/${urlParams.serviceId}`}
