...
import { ReactComponent as Packup } from "#lowcoder-design/icons/v1/icon-Pack-up.svg"
...
const PackupIcon = (props: any) => {
  const ChakraPackupIcon = chakra(Packup)
  return (
    <ChakraPackupIcon
      css={{
        height: "20px",
...
// const PackupIcon = chakra(Packup)`
//   height: 20px;
//   width: 20px;
//   float: right;
//   margin-top: 13px;
...
const SectionLabelDiv = chakra('div', {
  base: {
    display: "flex",
...
const TOOLTIP_CONTENT = (
  <TooltipWrapper>
    Here you can enter the animation type codes. Like bounce, swing or tada. Read more about all possible codes at:{" "}
