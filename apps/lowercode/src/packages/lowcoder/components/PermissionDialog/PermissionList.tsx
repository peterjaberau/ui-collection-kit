import { ASSETS_URI } from "#lowcoder/constants/apiConstants";
import { ApplicationPermissionType, ApplicationRoleType } from "#lowcoder/constants/applicationConstants";
import {
  CommonErrorLabel,
  CommonGrayLabel,
  CommonTextLabel,
