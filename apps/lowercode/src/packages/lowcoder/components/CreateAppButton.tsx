import { ApplicationDetail, AppTypeEnum } from "#lowcoder/constants/applicationConstants";
import { ActiveTextColor, LightActiveTextColor } from "#lowcoder/constants/style";
