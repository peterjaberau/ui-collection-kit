...
import { isValidColor, isValidGradient, toHex } from "#lowcoder-design/components/colorSelect/colorUtils";
import { ColorSelect } from "#lowcoder-design/components/colorSelect";
      ...
      {themeSettingKey === "gridColumns" && (
        <div className="config-input">
          ...
          <Slider
            ...
            onChange={(value: any) => setGridColumns(value.toString())}
            onChangeComplete={(value: any) => gridSizeInputBlur(value.toString())}
          />
        </div>
      )}
      ...
      {themeSettingKey === "gridRowHeight" && (
        <div className="config-input">
          ...
          <Slider
            ...
            onChange={(value: any) => setGridRowHeight(value.toString())}
            onChangeComplete={(value: any) => gridSizeInputBlur(value.toString())}
          />
        </div>
      )}
