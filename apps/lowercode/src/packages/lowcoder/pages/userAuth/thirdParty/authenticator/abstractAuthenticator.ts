import { AuthSessionStoreParams } from "#lowcoder/constants/authConstants";
import { authRespValidate, getRedirectUrl, getSafeAuthRedirectURL } from "#lowcoder/pages/userAuth/authUtils";
import { AxiosPromise } from "axios";
import { ApiResponse } from "#lowcoder/api/apiResponses";
import history from "#lowcoder/util/history";
import { AUTH_BIND_URL, AUTH_LOGIN_URL } from "#lowcoder/constants/routesURL";
