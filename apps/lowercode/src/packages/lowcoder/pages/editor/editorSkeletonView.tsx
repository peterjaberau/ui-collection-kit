import Header from "#lowcoder/pages/common/header";
import React, { lazy, useCallback, useEffect, useRef } from "react";
import {
  Body,
  EditorContainer,
  Height100Div,
} from "#lowcoder/pages/common/styledComponent";
import { getPanelStatus, getEditorModeStatus, getPanelStyle } from "#lowcoder/util/localStorageUtil";
// import { BottomSkeleton } from "#lowcoder/pages/editor/bottom/BottomContent";
// import RightPanel from "#lowcoder/pages/editor/right/RightPanel";
import _ from "lodash";

import styled from "styled-components";
import { default as Skeleton } from "antd/es/skeleton";
import { default as Spin } from "antd/es/spin";
import { useTemplateViewMode, useUserViewMode } from "#lowcoder/util/hooks";
