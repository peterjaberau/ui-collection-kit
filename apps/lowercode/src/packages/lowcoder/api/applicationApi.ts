...
} from "#lowcoder/redux/reduxActions/applicationActions"
...
import { fetchAppRequestType, GenericApiPaginationResponse } from "#lowcoder/util/pagination/type"
...
class ApplicationApi extends Api {
  ...
  static getApplicationPermissionURL = (applicationId: string) => `/applications/${applicationId}/permissions`
  static grantAppPermissionURL = (applicationId: string) => `/applications/${applicationId}/permissions`
  static publishApplicationURL = (applicationId: string) => `/applications/${applicationId}/publish`
  ...
  static getAvailableGroupsMembersURL = (applicationId: string) =>
    `/applications/${applicationId}/groups-members/available`
  ...
  static createApplicationWithDSL(request: CreateApplicationRequest): AxiosPromise<ApplicationResp> {
    return Api.post(ApplicationApi.createApplicationURL, request)
  }

  static recycleApplication(request: RecycleApplicationPayload): AxiosPromise<GenericApiResponse<Boolean>> {
    return Api.put(ApplicationApi.newURLPrefix + `/recycle/${request.applicationId}`)
  }

  static restoreApplication(request: RestoreApplicationPayload): AxiosPromise<GenericApiResponse<Boolean>> {
    return Api.put(ApplicationApi.newURLPrefix + `/restore/${request.applicationId}`)
  }

  static deleteApplication(request: DeleteApplicationPayload): AxiosPromise<GenericApiResponse<Boolean>> {
  ...
  static updateAppPermission(request: UpdateAppPermissionPayload): AxiosPromise<AppPermissionResponse> {
    const { applicationId, permissionId, ...requestParam } = request
    return Api.put(ApplicationApi.updateAppPermissionURL(applicationId, permissionId), requestParam)
  }

  static deleteAppPermission(request: DeleteAppPermissionPayload): AxiosPromise<AppPermissionResponse> {
