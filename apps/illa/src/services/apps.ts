import { fetchBatchCreateAction } from "@/public/create-app"
import { builderRequest } from "@/public/net"
import { AppInfoShape, ComponentTreeNode } from "@/public/public-types"
...
export const fetchPrivateAppInitData = async (
  ...
  return await builderRequest<any>(
    {
