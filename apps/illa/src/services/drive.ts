import { driveRequest, publicDriveRequest } from "@/public/net"
import {
  DRIVE_FILE_TYPE,
  DUPLICATION_HANDLER,
  EXPIRATION_TYPE,
...
export const fetchUploadFilesStatusAnonymous = async (appID: string, fileID: string, status: UPLOAD_FILE_STATUS) => {
...
export const fetchGetUploadFileURL = async (requestData: IFetchGetUploadFileURLRequest, abortSignal?: AbortSignal) => {
...
export const fetchUpdateFileStatus = async (fileID: string, status: UPLOAD_FILE_STATUS) => {
  return await driveRequest(
    {
...
export const fetchDownloadURLByTinyURL = async (tinyURL: string, fileID: string) => {
...
export type IFetchGenerateBatchTinyURLResponse = IFetchGenerateTinyURLResponseData & { fileID: string }
export const fetchBatchGenerateTinyUrl = async (data: IFetchGenerateTinyURLRequestData, abortSignal?: AbortSignal) => {
...
export const fetchGenerateTinyUrl = async (data: IFetchGenerateTinyURLRequestData, abortSignal?: AbortSignal) => {
  return await driveRequest<IFetchGenerateBatchTinyURLResponse>(
    {
      url: "/links",
      method: "POST",
...
export const fetchCheckFileExist = async (data: IFetchCheckFileExistRequestData[], abortSignal?: AbortSignal) => {
...
export const fetchGCSUploadPresignedURL = async (data: IFetchFileDetailRequestData, abortSignal?: AbortSignal) => {
  try {
