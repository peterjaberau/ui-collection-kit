...
import { Center, SimpleGrid, Stack, Text, VStack, defaultSystem } from "@chakra-ui/react"
        ...
        {allAspectRatios.map((token) => {
          return (
            <Stack key={token.name} flex="1">
              <Center aspectRatio={token.value} width="40" bg="bg.subtle" color="fg.muted" borderWidth="1px">
                <VStack gap="0">
