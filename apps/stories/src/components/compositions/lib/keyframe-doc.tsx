...
import { Box, Center, SimpleGrid, Stack, Text, VStack, defaultSystem } from "@chakra-ui/react"
        ...
        {allKeyframes.map((animationName) => {
          return (
            <Stack key={animationName}>
              <Box boxSize="12" bg="pink.200" animation={`${animationName} 1s ease-in-out infinite alternate`} />
