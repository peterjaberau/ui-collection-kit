export default {
  ...
  "editor": {
    ...
    "currentLayoutId": "68aac3acde8cf11f80e4a91b",
    "pageWidgetId": "0",
    "currentApplicationId": "68aac3acde8cf11f80e4a91a",
  ...
  "applications": {
    ...
    "currentApplication": {
      ...
      "lastDeployedAt": "2025-08-24T07:48:10.073Z",
      "evaluationVersion": 2,
      "applicationVersion": 2,
      "collapseInvisibleWidgets": true,
      "isManualUpdate": true,
      "forkedFromTemplateTitle": "List Lookup",
      "baseId": "68aac3acde8cf11f80e4a91a",
      "unpublishedThemeId": "68a9b7e9de8cf11f80e4a889",
      "publishedThemeId": "68a9b7e9de8cf11f80e4a889",
      "artifactType": "APPLICATION",
      "modifiedAt": "2025-08-24T08:10:59.682Z",
      "pages": [
        {
          "id": "68aac3acde8cf11f80e4a91c",
          "baseId": "68aac3acde8cf11f80e4a91c",
          "name": "List Lookup",
          "slug": "list-lookup",
          "isDefault": true,
          "isHidden": false,
  ...
  "users": {
    ...
    "productAlert": {
      "config": {
        "dismissed": false,
        "snoozeTill": "2025-08-24T09:48:12.031Z"
      }
    }
  },
  "widgetDragResize": {
  ...
  "pageWidgets": {
    "68aac3acde8cf11f80e4a91c": {
      ...
      "layoutId": "68aac3acde8cf11f80e4a91b"
    }
  },
  "theme": {
    "mode": "LIGHT",
  ...
  "debugger": {
    "logs": [
      {
        ...
        "state": {
          "requestParams": {
            "list_users.pageSize": 3,
            "(list_users.pageNo - 1) * list_users.pageSize": 0,
            "\"%\" + inp_name.text + \"%\"": "%%",
            "dat_bornAfter.selectedDate": "1979-12-31T18:30:00.000Z",
            "sel_country.selectedOptionValue !== \"\" ? \"AND country = '\" + sel_country.selectedOptionValue + \"'\" : \"\"": ""
          }
        },
        "severity": "info",
        "timestamp": "1756028894226",
    ...
    "isOpen": true,
    "errors": {
      "rgcfekuvi0onDropdownClose-lint": {
        "id": "rgcfekuvi0onDropdownClose-lint",
        "logType": 14,
        "text": "LINT ERROR",
        "messages": [
          {
        ...
        "source": {
          ...
          "name": "sel_country",
          "type": "WIDGET",
          "propertyPath": "onDropdownClose"
        },
        "severity": "error",
        "timestamp": "1756028895055",
        "occurrenceCount": 1,
        "category": "PLATFORM_GENERATED",
        "isExpanded": false
      }
    ...
    "context": {
      "scrollPosition": 0,
      "selectedDebuggerTab": "PLAYGROUND_TAB",
      "responseTabHeight": 259,
      "errorCount": 1,
