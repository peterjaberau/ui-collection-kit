...
export const evaluateAndExecuteDynamicTrigger = {
  input: {
    "dynamicTrigger": "{{storeValue('varCalculated', Input1.text)}}",
    "eventType": "ON_CLICK",
    "triggerMeta": {
      "source": {
        "id": "tl8xbeqhua",
      ...
      "triggerPropertyName": "onClick",
      "triggerKind": "EVENT_EXECUTION",
      "onPageLoad": false
    }
  },
  logic: {
    unEvalTree: {
      fn: 'getUnevalTreeWithWidgetsRegistered',
      output: {
        "unEvalTree": {
          "localVariables": {
            "varCalculated": "''",
          ...
          "dataTreeEvaluator": {
            ...
            "logs": [
              ...
              },
              {
                ...
                "addDependantsOfNestedPropertyPathsLatency": 0.10000000149011612,
                "trimDependantChangePathsLatency": 0,
                "completeSortOrderLatency": 0.10000000149011612
              },
              {
                "sortedDependencies": [
                  "appsmith.theme.boxShadow.appBoxShadow",
              ...
              },
              {
                "timeTakenForSetupUpdateTree": {
                  "calculateSubTreeSortOrder": "0.20 ms",
                  "clone": "0.00 ms"
                }
              },
              {
      ...
      evalTree: {
        ...
        "webworkerTelemetry": {
          "transferDataToWorkerThread": {
            "attributes": {},
            "spanName": "transferDataToWorkerThread",
            "startTime": 1756405719950,
            "endTime": 1756405719951
          },
          "__spanAttributes": {
          ...
          "SetupUpdateTree.Diff1": {
            "attributes": {},
            "spanName": "SetupUpdateTree.Diff1",
            "startTime": 1756405719952,
            "endTime": 1756405719952
          },
          "SetupUpdateTree.parseJSActions": {
            "attributes": {},
            "spanName": "SetupUpdateTree.parseJSActions",
            "startTime": 1756405719952,
            "endTime": 1756405719952
          },
          "unEvalTreeWithStringifiedJSFunctionsDiff": {
            "attributes": {},
            "spanName": "unEvalTreeWithStringifiedJSFunctionsDiff",
            "startTime": 1756405719952,
            "endTime": 1756405719952
          },
          "setupUpdateTree": {
            "attributes": {},
            "spanName": "setupUpdateTree",
            "startTime": 1756405719952,
            "endTime": 1756405719952
          },
          "evalAndValidateSubTree": {
            "attributes": {},
            "spanName": "evalAndValidateSubTree",
            "startTime": 1756405719952,
            "endTime": 1756405719952
          },
          "diffAndGenerateSerializeUpdates": {
            "attributes": {},
            "spanName": "diffAndGenerateSerializeUpdates",
            "startTime": 1756405719952,
            "endTime": 1756405719953
          }
        },
        "logs": [
          {
          ...
          {
            "updatedValuePathsLatency": 0.10000000149011612,
            "addDependantsOfNestedPropertyPathsLatency": 0,
            "trimDependantChangePathsLatency": 0,
            "completeSortOrderLatency": 0.19999999552965164
          },
          {
            "sortedDependencies": [
              "appsmith.theme.boxShadow.appBoxShadow",
          ...
          {
            "timeTakenForSetupUpdateTree": {
              "calculateSubTreeSortOrder": "0.30 ms",
              "clone": "0.00 ms"
            }
          },
          {
          ...
          {
            "log": "replay updating",
            "updateTime": "0.29999999701976776 ms"
          }
        ],
        "unEvalUpdates": [],
