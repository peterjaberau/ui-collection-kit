...
import { WorkerMessenger } from "#actor-workers/Evaluation/fns/utils/Messenger";
import { applyJSVariableUpdatesToEvalTree } from "#actor-workers/Evaluation/JSObject/JSVariableUpdates";
import ExecutionMetaData from "./ExecutionMetaData";
import type { UpdateActionProps } from "#actor-workers/Evaluation/handlers/types";
import { handleActionsDataUpdate } from "#actor-workers/Evaluation/handlers/updateActionData";
import { getEntityNameAndPropertyPath } from "#actor-workers/Evaluation/evaluationUtils";
...
const jsVariableUpdatesHandler = priorityBatchedActionHandler<any>(
  (batchedData) => {
...
export const jsVariableUpdatesHandlerWrapper = (patch: any) => {
