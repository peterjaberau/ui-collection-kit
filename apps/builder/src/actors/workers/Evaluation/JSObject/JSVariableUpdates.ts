...
import { EVAL_WORKER_SYNC_ACTION } from "#actor-constants";

export function getUpdatedPaths(potentialUpdatedPathsMap: any) {
  ...
  for (const [fullPath, patch] of patches as any) {
...
export function applyJSVariableUpdatesToEvalTree(updatesMap: any) {
