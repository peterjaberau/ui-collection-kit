...
import { PatchType } from "#actor-constants"

export default class JSObjectCollection {
  private static resolvedFunctions: any = {};
  private static unEvalState: any = {};
  private static variableState: any = {};
  private static prevUnEvalState: any = {};

  static setResolvedFunctions(resolvedFunctions: any) {
  ...
  static cachedJSVariablesByEntityName: any = {};
