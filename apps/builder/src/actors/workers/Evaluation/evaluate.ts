...
import { getDataTreeContext } from "#actor-workers/Evaluation/Actions";
...
export const EvaluationScripts: any = {
  "EXPRESSION": `
  function $$closedFn () {
...
export const getScriptType = (
  ...
  let scriptType = "EXPRESSION";

  if (evalArgumentsExist && isTriggerBased) {
    scriptType = "ASYNC_ANONYMOUS_FUNCTION";
  } else if (evalArgumentsExist && !isTriggerBased) {
    scriptType = "ANONYMOUS_FUNCTION";
...
// TODO: Fix this the next time the file is edited
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export function shouldAddSetter(setter: any, entity: any) {
