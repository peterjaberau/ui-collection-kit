const widgetDefaultPropertiesMap = new Map([
  [
    "WDS_BUTTON_WIDGET",
    {
      animateLoading: true,
  ...
  [
    "DATE_PICKER_WIDGET2",
    {
      ...
      columns: 20,
      widgetName: "DatePicker",
      defaultDate: "2025-08-26T15:44:22.002Z",
  ...
  [
    "LIST_WIDGET_V2",
    {
      ...
      widgetName: "List",
      children: [],
      additionalStaticProps: ["level", "levelData", "prefixMetaWidgetId", "metaWidgetId"],
...
const widgetBuilderMap = new Map([
  [
    "WDS_BUTTON_WIDGET",
    null
  ],
