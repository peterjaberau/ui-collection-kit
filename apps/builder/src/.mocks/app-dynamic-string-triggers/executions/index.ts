...
const onClickButton = [
  {
    type: 'execution/updateExecutionByDisplayNameReducer',
    payload: {
      displayName: 'txt_left_dynamic',
      value: {
        value: 'Dynamic: STATIC text from left container'
      }
    }
  },

  {
    type: 'config/updateSelectedComponent',
    payload: [
      'btn_left_left'
    ]
  },
  ...
  {
    type: 'config/addExpandedWidgetReducer',
    payload: [
      'canvas1',
      'toolPanelLeft',
  ...
  {
    type: 'collaborators/updateComponentAttachedUsers',
    payload: {
      btn_left_left: [
        {
          id: 'ILAfx4p1C7dZ',
...
const AppInitialized = [
  {
    type: 'team/updateCurrentIdReducer',
    payload: 'ILAfx4p1C7d0'
  },

  {
    type: 'team/updateTeamItemsReducer',
    payload: [
      {
        id: 'ILAfx4p1C7d0',
  ...
  {
    type: 'collaborators/setInRoomUsers',
    payload: {
      inRoomUsers: []
    }
  },
  {
    type: 'config/updateWSStatusReducer',
    payload: {
      context: 'APP',
      wsStatus: 'CLOSED'
    }
  ...
  {
    type: 'execution/resetExecutionResultReducer'
  },
  {
    type: 'config/resetConfig'
  },
  {
    type: 'action/resetActionReducer'
  },
  {
    type: 'components/resetComponentsReducer'
  },
  {
    type: 'cursor/resetCursorReducer'
  },
  {
    type: 'dragShadow/resetDragShadowInfoReducer'
  },
  {
    type: 'appInfo/updateAppInfoReducer',
    payload: {
      updatedAt: '',
      updatedBy: '',
      appId: '',
  ...
  {
    type: 'resource/updateResourceListReducer',
    payload: []
  },
  {
    type: 'config/updateIllaMode',
    payload: 'edit'
  },
  {
    type: 'appInfo/updateAppInfoReducer',
  ...
  {
    type: 'components/initComponentReducer',
    payload: {
      root: {
        version: 0,
        displayName: 'root',
  ...
  {
    type: 'action/initActionListReducer',
    payload: []
  },
  {
  ...
  {
    type: 'layoutInfo/setWidgetLayoutInfoReducer',
    payload: {
      root: {
        displayName: 'root',
        parentNode: '',
  ...
  {
    type: 'config/updateDevicesOnlineStatusReducer',
    payload: true
  },
  {
    type: 'config/updateWSStatusReducer',
  ...
  {
    type: 'config/updateCanvasShapeReducer',
    payload: {
      canvasHeight: 0,
      canvasWidth: 0
    }
  ...
  {
    type: 'layoutInfo/updateWidgetLayoutInfoReducer',
    payload: {
      displayName: 'contentLeft',
      layoutInfo: {
        h: 22
  ...
  {
    type: 'layoutInfo/batchUpdateWidgetLayoutInfoReducer',
    payload: [
      {
        displayName: 'toolPanelLeft',
        layoutInfo: {
