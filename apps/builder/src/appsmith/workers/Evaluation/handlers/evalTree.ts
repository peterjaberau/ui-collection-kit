...
import { makeEntityConfigsAsObjProperties } from "ce/workers/Evaluation/dataTreeUtils";
import type { DataTreeDiff } from "ce/workers/Evaluation/evaluationUtils";
import { serialiseToBigInt } from "ce/workers/Evaluation/evaluationUtils";
import { getSafeToRenderDataTree } from "ce/workers/Evaluation/evaluationUtils";
...
export let replayMap: Record<string, ReplayEntity<any>> | undefined | any;
export let dataTreeEvaluator: DataTreeEvaluator | any;
