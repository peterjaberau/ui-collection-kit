...
} from "ce/workers/Evaluation/evalWorkerActions";
...
import type { WorkerRequest } from "ce/workers/common/types";
...
export interface EvalTreeRequestData {
  ...
  widgetTypeConfigMap: any; //WidgetTypeConfigMap
...
export interface EvalTreeResponseData {
  ...
  webworkerTelemetry?: any; //Record<string, WebworkerSpanData | Attributes>;
  updates: string;
