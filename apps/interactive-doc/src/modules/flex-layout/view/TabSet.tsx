          ...
          <div className={cm(CLASSES.FLEXLAYOUT__MINI_SCROLLBAR_CONTAINER)}>
            <div
              ...
              className={
                ...
                " " +
                cm(CLASSES.FLEXLAYOUT__TABSET_TABBAR_INNER_ + node.getTabLocation())
              }
            ...
            >
              <Box
                ...
                className={
                  ...
                  " " +
                  cm(CLASSES.FLEXLAYOUT__TABSET_TABBAR_INNER_TAB_CONTAINER_ + node.getTabLocation())
                }
              >
                {tabs}
              </Box>
