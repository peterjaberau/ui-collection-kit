...
export const DockviewReact = React.forwardRef(
  (props: IDockviewReactProps | any, ref: React.ForwardedRef<HTMLDivElement>) => {
    const domRef = React.useRef<HTMLDivElement>(null);
    const dockviewRef = React.useRef<DockviewApi | any>(null);
    ...
    React.useEffect(() => {
      ...
      const frameworkTabComponents: any = props.tabComponents ?? {};
    ...
    React.useEffect(() => {
      ...
      const disposable = dockviewRef.current.onDidDrop((event: any) => {
        if (props.onDidDrop) {
    ...
    React.useEffect(() => {
      ...
      const disposable = dockviewRef.current.onWillDrop((event: any) => {
        if (props.onWillDrop) {
