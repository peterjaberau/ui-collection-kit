    ...
    implements ITabsContainer
{
    ...
    private readonly voidContainer: VoidContainer | any;
    ...
    constructor(
        ...
        this.addDisposables(
            ...
            this.voidContainer,
            this.voidContainer.onDragStart((event: any) => {
                this._onGroupDragStart.fire({
                    nativeEvent: event,
                    group: this.group,
                });
            }),
            this.voidContainer.onDrop((event: any) => {
                this._onDrop.fire({
                    event: event.nativeEvent,
                    index: this.tabs.size,
                });
            }),
            this.voidContainer.onWillShowOverlay((event: any) => {
