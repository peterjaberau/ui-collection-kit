...
import { applyBoxStyle } from "../theme/style"
...
export const Trigger: FC<TriggerProps> = (props) => {
  ...
  const closeContent = <div style={{ fontSize: '14px' }}>{content}</div>
  ...
  switch (placement) {
    ...
    case "top-end":
      centerNode = (
        <div
          // css={applyVerticalContainer(autoAlignPopupWidth)}
          style={{
            display: "inline-flex",
    ...
    case "bottom-end":
      centerNode = (
        <chakra.div css={applyVerticalContainer(autoAlignPopupWidth)}>
          {showArrow && (
            <TriangleBottom
              w="8px"
              h="4px"
    ...
    case "right-end":
      centerNode = (
        <chakra.div css={applyHorizontalContainer(autoAlignPopupWidth)}>
          {showArrow && (
            <TriangleRight
              w="4px"
              h="8px"
  ...
  const tipsNode = (
    <motion.div
      style={applyMotionDiv(autoAlignPopupWidth)}
