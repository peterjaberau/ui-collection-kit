...
export const isVariableDeclaration = (node: Node): node is VariableDeclarationNode => {
  return node.type === NodeTypes.VariableDeclaration
}

export const isVariableDeclarator = (node: Node): node is VariableDeclaratorNode => {
  return node.type === NodeTypes.VariableDeclarator
}

export const isFunctionDeclaration = (node: Node): node is FunctionDeclarationNode => {
  return node.type === NodeTypes.FunctionDeclaration
}

export const isFunctionExpression = (node: Node): node is FunctionExpressionNode => {
  return node.type === NodeTypes.FunctionExpression
}
export const isArrowFunctionExpression = (node: Node): node is ArrowFunctionExpressionNode => {
  return node.type === NodeTypes.ArrowFunctionExpression
}

export const isAssignmentExpression = (node: Node): node is AssignmentExpressionNode => {
...
export const isAssignmentPatternNode = (node: Node): node is AssignmentPatternNode => {
...
export const isExportDefaultDeclarationNode = (node: Node): node is ExportDefaultDeclarationNode => {
  return node.type === NodeTypes.ExportDefaultDeclaration
}

export const isPropertyAFunctionNode = (node: Node): node is ArrowFunctionExpressionNode | FunctionExpressionNode => {
  return node.type === NodeTypes.ArrowFunctionExpression || node.type === NodeTypes.FunctionExpression
}

export const isArrayAccessorNode = (node: Node): node is MemberExpressionNode => {
