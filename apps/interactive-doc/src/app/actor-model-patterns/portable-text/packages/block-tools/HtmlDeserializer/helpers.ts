...
import { isTextBlock, type PortableTextObject, type PortableTextTextBlock } from "#actor-portable-text/packages/schema"
...
export function preprocess(html: string, parseHtml: HtmlParser, options: HtmlPreprocessorOptions): Document {
 ...
 * @returns
 */
export function trimWhitespace(schema: Schema, blocks: TypedObject[]): TypedObject[] {
...
export function ensureRootIsBlocks(schema: Schema, objects: Array<ArbitraryTypedObject>): ArbitraryTypedObject[] {
