...
export const appDynamicStringTriggersMock: any = () => {
  return {
    config: {
      ...
      openDebugger: false,
      scale: 100,
      selectedComponents: ["txt_left_summary"],
      selectedAction: null,
      cachedAction: null,
      showDot: false,
      expandedKeys: [],
    ...
    currentApp: {
      ...
      appInfo: {
        ...
        config: {
          ...
          cover: "",
          appType: "pc",
          components: ["BUTTON_WIDGET", "CONTAINER_WIDGET", "TEXT_WIDGET"],
          actions: [],
        },
    ...
    currentApp: {
      components: {
        ...
        "bodySection1-bodySectionContainer1": {
          ...
          parentNode: "bodySection1",
          showName: "bodySection1-bodySectionContainer1",
          childrenNode: ["button1", "input1", "button2"],
          type: "CONTAINER_NODE",
          containerType: "EDITOR_DOT_PANEL",
          h: 0,
          w: 0,
      ...
      appInfo: {
        ...
        config: {
          ...
          cover: "",
          appType: "pc",
          components: ["INPUT_WIDGET", "BUTTON_WIDGET"],
          actions: [
            {
              actionID: "ILAfx4p1C7dT",
              uid: "2d4fabdd-fe65-44a5-ab5c-f078dd4ec64e",
      ...
      execution: {
        dependencies: {
          "transformer1.value": [],
          "button1.text": ["builderInfo.version"],
          "input1.labelWidth": [],
          "input1.formDataKey": ["input1.displayName"],
          "input1.showVisibleButton": [],
          "button2.text": ["builderInfo.language"],
          "currentPageInfo.pagePath": ["root.pageSortedKey", "root.currentPageIndex"],
          "currentPageInfo.subPagePath": ["root.currentSubPagePath"],
        },
        result: {
        ...
        independencies: {
          ...
          "root.pageSortedKey": ["currentPageInfo.pagePath"],
          "root.currentPageIndex": ["currentPageInfo.pagePath"],
          "builderInfo.language": ["button2.text"],
          "input1.displayName": ["input1.formDataKey"],
          "builderInfo.version": ["button1.text"],
        },
      },
      cursor: {},
      dragShadow: {},
