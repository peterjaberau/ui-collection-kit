...
export const PREVIOUS_CONFIG_VERSION = 1
...
export function createBaseConfig() {
  ...
  return {
    ...
    previousVersion: PREVIOUS_CONFIG_VERSION,
    connections: [],
...
export function createBaseAuthentication() {
  return {
    protocol: "wss",
    hostname: "",
    username: "",
...
export function createBaseConnection(settings: any) {
...
export function createBaseQuery(settings: any, type: any) {
  return {
    id: newId(),
    type,
    query: "",
...
export function createSandboxConnection(settings: any) {
