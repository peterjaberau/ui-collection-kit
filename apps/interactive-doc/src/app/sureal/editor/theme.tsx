 ...
 */
export const editorTheme = (colorScheme: any, syntaxTheme: any) =>
 ...
 */
export function createStyleHighlighter(colorScheme: any, syntaxTheme: any) {
	return tagHighlighter(
		THEME_CONFIGS[syntaxTheme][colorScheme].specs.map((a: any) => ({ ...a, class: a.color })),
	);
}
