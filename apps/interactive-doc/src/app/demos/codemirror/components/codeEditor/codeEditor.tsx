"use client"
import React, { RefObject, ReactNode, useCallback, useEffect, useRef, useState } from 'react';
...
function useCodeMirror(props: CodeEditorProps, container: RefObject<HTMLDivElement | undefined>) {
...
function CodeEditorCommon(
  props: CodeEditorProps & {
    editor: RefObject<HTMLDivElement | undefined>;
    children: ReactNode;
    disabled?: boolean;
