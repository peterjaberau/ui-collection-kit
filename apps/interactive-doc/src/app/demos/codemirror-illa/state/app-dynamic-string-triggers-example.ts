...
export const getGlobalCalcContextWithLimit = () => {
  return {
    "toolPanelLeft": {
      "$dynamicAttrPaths": [],
...
export const getCurrentPageCalcContext = () => {
  return {
    "toolPanelLeft": {
      "$dynamicAttrPaths": [],
      "backgroundColor": "#ffffffff",
...
//CodeEditorIndex
export const getExecutionResultToCurrentPageCodeMirror = () => {
  return {
    "toolPanelLeft": {
      "$dynamicAttrPaths": [],
      "backgroundColor": "#ffffffff",
...
export const getExecutionResultToGlobalCodeMirror = () => {
  return {
    "toolPanelLeft": {
      "$dynamicAttrPaths": [],
      "backgroundColor": "#ffffffff",
...
export const rootState = {
  ...
  currentApp: {
    ...
    appInfo: {
      ...
      updatedAt: '2025-09-27T17:11:08.391216Z',
      appActivity: {
        modifier: 'root',
        modifiedAt: '2025-09-27T17:11:08.391216Z'
      },
      editedBy: [
        {
          userID: 'ILAfx4p1C7dZ',
          ...
          email: 'root',
          avatar: '',
          editedAt: '2025-09-27T17:11:08.391216959Z'
        }
      ]
    },
    collaborators: {
