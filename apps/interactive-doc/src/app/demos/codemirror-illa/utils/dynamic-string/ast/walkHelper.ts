...
import { isAssignmentPatternNode, isIdentifierNode, isLiteralNode } from "./typeHelper"

export const getPropertyAccessor = (propertyNode: IdentifierNode | LiteralNode) => {
...
export const constructFinalMemberExpIdentifier = (node: MemberExpressionNode, child = ""): string => {
...
export const getFunctionalParamNamesFromNode = (
  node: FunctionDeclarationNode | FunctionExpressionNode | ArrowFunctionExpressionNode,
) => {
