...
import { IdentifierNode, MemberExpressionNode, NodeList, RefactorIdentifierNode } from "./interface"
import {
  isArrayAccessorNode,
...
import { constructFinalMemberExpIdentifier, getFunctionalParamNamesFromNode } from "./walkHelper"
...
export const ancestorWalk = (ast: Node): NodeList => {
  ...
  ancestor(ast, {
    Identifier(node: Node, ancestors: Node[]) {
       ...
       * */
      let candidateTopLevelNode: IdentifierNode | MemberExpressionNode = node as IdentifierNode
