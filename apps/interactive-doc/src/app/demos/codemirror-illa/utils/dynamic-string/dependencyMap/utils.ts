...
import { IMMEDIATE_PARENT_REGEX } from "#codemirror-illa/utils"
import { convertPathToString } from "../converter"

export function sortDependencies(dependencyMap: DependencyMap): any {
...
const makeParentsDependOnChild = (dependencyMap: DependencyMap, child: string) => {
  ...
  while ((matches = curKey.match(IMMEDIATE_PARENT_REGEX)) !== null) {
    const immediateParent: any = matches[1]
