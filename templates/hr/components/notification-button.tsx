    ...
    <Popover.Root>
      ...
      >
        <TabMenuHorizontal.Root defaultValue='all'>
          ...
          <div className='flex h-12 items-center justify-end border-t border-stroke-soft-200 px-5 md:justify-between'>
            <div className='hidden items-center gap-2 text-paragraph-xs text-text-sub-600 md:flex'>
              Use
              <div className='flex size-5 shrink-0 items-center justify-center rounded bg-bg-weak-50 text-text-sub-600 ring-1 ring-inset ring-stroke-soft-200'>
