...
const calcBreakpointIndex: ICalcBreakpointIndex = (breakpoints: any, width) => {
...
const calcFactor: any = <T>(value: T | T[] | any, breakpointIndex?: number): T => {
...
const factor = <T>(value: T | T[], breakpointIndex?: number): any =>
...
export const useResponsiveFormLayout: IUseResponsiveFormLayout | any = (props: any) => {
