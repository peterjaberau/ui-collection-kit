 ...
 * but optimized for UIKit UI. All credits to the original authors.
 *
...
const createStyled = (tag: any, configOrCva: any = {}, options: any = {}) => {
  ...
  const Styled: any = withEmotionCache((inProps: any, cache, ref) => {
    const { cva, isValidProperty } = useUIKitContext()
...
const uikitImpl = new Proxy(styledFn, {
  apply(_, __, args) {
    // @ts-ignore
...
export const uikit = uikitImpl as unknown as StyledFactoryFn
