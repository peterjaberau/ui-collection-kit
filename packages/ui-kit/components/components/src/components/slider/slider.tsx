...
export interface SliderRootProviderProps
  extends HTMLUIKitProps<"div", SliderRootProviderBaseProps> {}
...
export interface SliderRootProps
  extends HTMLUIKitProps<"div", SliderRootBaseProps> {}
...
export interface SliderTrackProps
  extends HTMLUIKitProps<"div", ArkSlider.TrackBaseProps> {}
...
export interface SliderRangeProps
  extends HTMLUIKitProps<"div", ArkSlider.RangeBaseProps> {}
...
export interface SliderThumbProps
  extends HTMLUIKitProps<"div", ArkSlider.ThumbBaseProps> {}
...
export interface SliderValueTextProps
  extends HTMLUIKitProps<"div", ArkSlider.ValueTextBaseProps> {}
...
export interface SliderLabelProps
  extends HTMLUIKitProps<"label", ArkSlider.LabelBaseProps> {}
...
export interface SliderMarkerGroupProps
  extends HTMLUIKitProps<"div", ArkSlider.MarkerGroupBaseProps> {}
...
export interface SliderMarkerProps
  extends HTMLUIKitProps<"div", ArkSlider.MarkerBaseProps> {}
...
export interface SliderDraggingIndicatorProps
  extends HTMLUIKitProps<"div", ArkSlider.DraggingIndicatorBaseProps> {}
        ...
        {marks.map((mark, index) => {
          ...
          return (
            <SliderMarker key={index} value={value}>
              ...
              {label != null && (
                <span className="uikit-slider__marker-label">{label}</span>
              )}
            </SliderMarker>
          )
        })}
...
export interface SliderControlProps
  extends HTMLUIKitProps<"div", ArkSlider.ControlBaseProps> {}
