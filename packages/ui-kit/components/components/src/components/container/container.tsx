...
export interface ContainerProps extends HTMLUIKitProps<"div", ContainerBaseProps> {}

export const Container = withContext<HTMLDivElement, ContainerProps>("div")

export const ContainerPropsProvider = PropsProvider as React.Provider<ContainerBaseProps>
