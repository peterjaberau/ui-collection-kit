...
export interface FieldsetRootProps
  extends HTMLUIKitProps<"fieldset", FieldsetRootBaseProps> {}
...
export interface FieldsetErrorTextProps
  extends HTMLUIKitProps<"span", Fieldset.ErrorTextBaseProps> {}
...
export interface FieldsetHelperTextProps
  extends HTMLUIKitProps<"span", Fieldset.HelperTextBaseProps> {}
...
export interface FieldsetLegendProps
  extends HTMLUIKitProps<"legend", Fieldset.LegendBaseProps> {}
