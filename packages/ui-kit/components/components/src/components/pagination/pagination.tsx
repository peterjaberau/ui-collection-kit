...
export interface PaginationRootProviderProps
  extends HTMLUIKitProps<"div", PaginationRootProviderBaseProps> {}
...
export interface PaginationRootProps
  extends HTMLUIKitProps<"div", PaginationRootBaseProps> {}
...
export interface PaginationEllipsisProps
  extends HTMLUIKitProps<"div", ArkPagination.EllipsisBaseProps> {}
...
export interface PaginationItemProps
  extends HTMLUIKitProps<"button", ArkPagination.ItemBaseProps> {}
...
export interface PaginationNextTriggerProps
  extends HTMLUIKitProps<"button", ArkPagination.NextTriggerBaseProps> {}
...
export interface PaginationPrevTriggerProps
  extends HTMLUIKitProps<"button", ArkPagination.PrevTriggerBaseProps> {}
