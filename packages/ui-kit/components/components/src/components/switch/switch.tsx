...
export interface SwitchRootProviderProps
  extends HTMLUIKitProps<"label", SwitchRootProviderBaseProps> {}
...
export interface SwitchRootProps
  extends HTMLUIKitProps<"label", SwitchRootBaseProps> {}
...
export interface SwitchLabelProps
  extends HTMLUIKitProps<"span", ArkSwitch.LabelBaseProps> {}
...
export interface SwitchThumbProps
  extends HTMLUIKitProps<"span", ArkSwitch.ThumbBaseProps> {}
...
export interface SwitchControlProps
  extends HTMLUIKitProps<"span", ArkSwitch.ControlBaseProps> {}
