...
export interface ToasterProps
  extends HTMLUIKitProps<"div", ToasterBaseProps> {}

export const Toaster = uikit(
  ArkToaster,
  {},
  { forwardAsChild: true },
...
export interface ToastRootProps
  extends HTMLUIKitProps<"div", ToastRootBaseProps> {}
...
export interface ToastCloseTriggerProps
  extends HTMLUIKitProps<"button", ArkToast.CloseTriggerProps> {}
...
export interface ToastTitleProps
  extends HTMLUIKitProps<"div", ArkToast.TitleProps> {}
...
export interface ToastDescriptionProps
  extends HTMLUIKitProps<"div", ArkToast.DescriptionProps> {}
...
export interface ToastActionTriggerProps
  extends HTMLUIKitProps<"button", ArkToast.ActionTriggerProps> {}
