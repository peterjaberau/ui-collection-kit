...
import { Avatar as ArkAvatar } from "@ui-kit/base/avatar"
...
export interface AvatarRootProviderProps extends HTMLUIKitProps<"div", AvatarRootProviderBaseProps> {}

export const AvatarRootProvider = withProvider<HTMLDivElement, AvatarRootProviderProps>(
...
export interface AvatarRootProps extends HTMLUIKitProps<"div", AvatarRootBaseProps> {}

export const AvatarRoot = withProvider<HTMLDivElement, AvatarRootProps>(ArkAvatar.Root, "root", {
  forwardAsChild: true,
})

////////////////////////////////////////////////////////////////////////////////////

export const AvatarPropsProvider = PropsProvider as React.Provider<AvatarRootBaseProps>

////////////////////////////////////////////////////////////////////////////////////

export interface AvatarFallbackProps extends HTMLUIKitProps<"div", ArkAvatar.FallbackProps> {
  /**
...
const StyledFallback = uikit(ArkAvatar.Fallback, {}, { forwardAsChild: true })
...
export const AvatarFallback = forwardRef<HTMLDivElement, AvatarFallbackProps>(function AvatarFallback(props, ref) {
...
export interface AvatarImageProps extends HTMLUIKitProps<"img", ArkAvatar.ImageProps> {}

export const AvatarImage = withContext<HTMLImageElement, AvatarImageProps>(ArkAvatar.Image, "image", {
  forwardAsChild: true,
  defaultProps: {
    draggable: "false",
...
export interface AvatarIconProps extends HTMLUIKitProps<"svg"> {}

export const AvatarIcon = forwardRef<SVGElement, AvatarIconProps>(function AvatarIcon(props, ref) {
  return (
    <uikit.svg
      stroke="currentColor"
      fill="currentColor"
