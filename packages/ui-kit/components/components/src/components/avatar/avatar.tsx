...
export interface AvatarRootProviderProps
  extends HTMLUIKitProps<"div", AvatarRootProviderBaseProps> {}
...
export interface AvatarRootProps
  extends HTMLUIKitProps<"div", AvatarRootBaseProps> {}
...
export interface AvatarFallbackProps
  extends HTMLUIKitProps<"div", ArkAvatar.FallbackProps> {
  /**
...
export interface AvatarImageProps
  extends HTMLUIKitProps<"img", ArkAvatar.ImageProps> {}
