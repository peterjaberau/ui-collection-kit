...
import { Field as ArkField, useFieldContext } from "@ui-kit/base/field"
...
export interface FieldErrorIconProps extends HTMLUIKitProps<"svg"> {}
...
export interface FieldRequiredIndicatorProps extends HTMLUIKitProps<"span"> {
