...
export interface ProgressCircleRootProviderProps
  extends HTMLUIKitProps<"div", ProgressCircleRootProviderBaseProps> {}
...
export interface ProgressCircleRootProps
  extends HTMLUIKitProps<"div", ProgressCircleRootBaseProps> {}
...
export interface ProgressCircleLabelProps
  extends HTMLUIKitProps<"div", ArkProgress.LabelBaseProps> {}
...
export interface ProgressCircleCircleProps
  extends HTMLUIKitProps<"svg", ArkProgress.CircleBaseProps> {}
...
export interface ProgressCircleTrackProps
  extends HTMLUIKitProps<"circle", ArkProgress.TrackBaseProps> {}
...
export interface ProgressCircleRangeProps
  extends HTMLUIKitProps<"circle", ArkProgress.RangeBaseProps> {}
...
export interface ProgressCircleValueTextProps
  extends HTMLUIKitProps<"div", ArkProgress.ValueTextBaseProps> {}
