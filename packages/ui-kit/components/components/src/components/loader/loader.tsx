...
import type { HTMLUIKitProps } from "../../styled-system"
import { AbsoluteCenter } from "../center"
import { Span } from "../span"
import { Spinner } from "../spinner"

export interface LoaderProps extends HTMLUIKitProps<"span"> {
  /**
...
export const Loader = React.forwardRef<HTMLSpanElement, LoaderProps>(function Loader(props, ref) {
  const {
