...
export interface ClipboardRootProviderProps
  extends HTMLUIKitProps<"div", ClipboardRootProviderBaseProps> {}
...
export interface ClipboardRootProps
  extends HTMLUIKitProps<"div", ClipboardRootBaseProps> {}
...
export interface ClipboardTriggerProps
  extends HTMLUIKitProps<"button", ArkClipboard.TriggerProps> {}
...
export interface ClipboardControlProps
  extends HTMLUIKitProps<"div", ArkClipboard.ControlProps> {}
...
export interface ClipboardIndicatorProps
  extends HTMLUIKitProps<"div", ArkClipboard.IndicatorProps> {}
...
export interface ClipboardInputProps
  extends HTMLUIKitProps<"input", ArkClipboard.InputProps> {}
...
export interface ClipboardLabelProps
  extends HTMLUIKitProps<"label", ArkClipboard.LabelProps> {}
...
export interface ClipboardValueTextProps
  extends HTMLUIKitProps<"div", ArkClipboard.ValueTextProps> {}
