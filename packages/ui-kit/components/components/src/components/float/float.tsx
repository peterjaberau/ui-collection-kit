...
import { type ConditionalValue, type HTMLUIKitProps, type SystemStyleObject, uikit } from "../../styled-system"
...
export interface FloatProps extends Omit<HTMLUIKitProps<"div">, keyof FloatOptions>, FloatOptions {}

export const Float = forwardRef<HTMLDivElement, FloatProps>(function Float(props, ref) {
