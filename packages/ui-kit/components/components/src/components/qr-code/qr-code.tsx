...
export interface QrCodeRootProps
  extends HTMLUIKitProps<"div", QrCodeRootBaseProps> {}
...
export interface QrCodeRootProviderProps
  extends HTMLUIKitProps<"div", QrCodeRootProviderBaseProps> {}
...
export interface QrCodeDownloadTriggerProps
  extends HTMLUIKitProps<"button", ArkQrCode.DownloadTriggerBaseProps> {}
