...
export interface NumberInputRootProviderProps
  extends HTMLUIKitProps<"div", NumberInputRootProviderBaseProps> {}
...
export interface NumberInputRootProps
  extends HTMLUIKitProps<"div", NumberInputRootBaseProps> {}
...
export interface NumberInputLabelProps
  extends HTMLUIKitProps<"label", ArkNumberInput.LabelBaseProps> {}
...
export interface NumberInputInputProps
  extends HTMLUIKitProps<"input", ArkNumberInput.InputBaseProps> {}
...
export interface NumberInputControlProps
  extends HTMLUIKitProps<"div", ArkNumberInput.ControlBaseProps> {}
...
export interface NumberInputScrubberProps
  extends HTMLUIKitProps<"div", ArkNumberInput.ScrubberBaseProps> {}
...
export interface NumberInputValueTextProps
  extends HTMLUIKitProps<"span", ArkNumberInput.ValueTextBaseProps> {}
