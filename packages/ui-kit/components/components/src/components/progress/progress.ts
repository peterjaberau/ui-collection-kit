...
export interface ProgressRootProviderProps
  extends HTMLUIKitProps<"div", ProgressRootProviderBaseProps> {}
...
export interface ProgressRootProps
  extends HTMLUIKitProps<"div", ProgressRootBaseProps> {}
...
export interface ProgressTrackProps
  extends HTMLUIKitProps<"div", ArkProgress.TrackBaseProps> {}
...
export interface ProgressRangeProps
  extends HTMLUIKitProps<"div", ArkProgress.RangeBaseProps> {}
