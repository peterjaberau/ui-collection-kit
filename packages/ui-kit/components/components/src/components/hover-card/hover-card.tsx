...
export interface HoverCardTriggerProps
  extends HTMLUIKitProps<"button", ArkHoverCard.TriggerBaseProps> {}
...
export interface HoverCardPositionerProps
  extends HTMLUIKitProps<"div", ArkHoverCard.PositionerBaseProps> {}
...
export interface HoverCardContentProps
  extends HTMLUIKitProps<"section", ArkHoverCard.ContentBaseProps> {}
...
export interface HoverCardArrowTipProps
  extends HTMLUIKitProps<"div", ArkHoverCard.ArrowTipBaseProps> {}
...
export interface HoverCardArrowProps
  extends HTMLUIKitProps<"div", ArkHoverCard.ArrowBaseProps> {}
