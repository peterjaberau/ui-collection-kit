...
export interface AccordionRootProviderProps
  extends HTMLUIKitProps<"div", AccordionRootProviderBaseProps> {}
...
export interface AccordionRootProps
  extends HTMLUIKitProps<"div", AccordionRootBaseProps> {}
...
export interface AccordionItemProps
  extends HTMLUIKitProps<"div", ArkAccordion.ItemBaseProps> {}
...
export interface AccordionItemContentProps
  extends HTMLUIKitProps<"div", ArkAccordion.ItemContentBaseProps> {}
...
export interface AccordionItemTriggerProps
  extends HTMLUIKitProps<"button", ArkAccordion.ItemTriggerBaseProps> {}
...
export interface AccordionItemIndicatorProps
  extends HTMLUIKitProps<"button", ArkAccordion.ItemIndicatorBaseProps> {}
