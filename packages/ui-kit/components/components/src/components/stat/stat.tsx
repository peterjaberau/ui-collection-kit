...
const { withProvider, withContext, useStyles: useStatStyles, PropsProvider } = createSlotRecipeContext({ key: "stat" })
...
export interface StatRootProps extends HTMLUIKitProps<"dl", StatRootBaseProps> {}

export const StatRoot = withProvider<HTMLDListElement, StatRootProps>("dl", "root")
...
export const StatDownIndicator = withContext<HTMLElement, StatDownIndicatorProps>("span", "indicator", {
  defaultProps: {
    "data-type": "down",
...
export interface StatGroupProps extends SlotRecipeProps<"stat">, HTMLUIKitProps<"div"> {}
