...
import { GET_ROLES } from '@twenty-modules/settings/roles/graphql/queries/getRolesQuery';
...
import { SettingsRolePermissions } from '@twenty-modules/settings/roles/role-permissions/components/SettingsRolePermissions';
import { SettingsRoleSettings } from '@twenty-modules/settings/roles/role-settings/components/SettingsRoleSettings';
import { SettingsRoleLabelContainer } from '@twenty-modules/settings/roles/role/components/SettingsRoleLabelContainer';
...
import { getDirtyFields } from '@twenty-ui/front/utils/getDirtyFields';
