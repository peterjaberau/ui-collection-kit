import { SettingsRoleAssignmentConfirmationModalSubtitle } from '@twenty-modules/settings/roles/role-assignment/components/SettingsRoleAssignmentConfirmationModalSubtitle';
