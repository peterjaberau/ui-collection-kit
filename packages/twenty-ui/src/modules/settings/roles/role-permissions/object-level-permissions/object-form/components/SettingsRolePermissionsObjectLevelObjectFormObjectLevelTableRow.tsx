import { OverridableCheckbox } from '@twenty-modules/settings/roles/role-permissions/object-level-permissions/object-form/components/OverridableCheckbox';
import { SETTINGS_ROLE_OBJECT_LEVEL_PERMISSION_TO_ROLE_OBJECT_PERMISSION_MAPPING } from '@twenty-modules/settings/roles/role-permissions/objects-permissions/constants/settingsRoleObjectLevelPermissionToRoleObjectPermissionMapping';
import { SETTINGS_ROLE_OBJECT_PERMISSION_ICON_CONFIG } from '@twenty-modules/settings/roles/role-permissions/objects-permissions/constants/settingsRoleObjectPermissionIconConfig';
import { SettingsRolePermissionsObjectLevelPermission } from '@twenty-modules/settings/roles/role-permissions/objects-permissions/types/SettingsRolePermissionsObjectPermission';
...
import { ObjectPermission } from '@twenty-ui/front/generated-metadata/graphql';
import type { Role } from '@twenty-ui/front/generated/graphql';
