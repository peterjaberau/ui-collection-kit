...
import { SettingsRolePermissionsObjectLevelOverrideCell } from '@twenty-modules/settings/roles/role-permissions/object-level-permissions/components/SettingsRolePermissionsObjectLevelOverrideCell';
