...
import { useSettingsPermissionMap } from "@twenty-modules/settings/roles/hooks/useSettingsPermissionMap"
import { NavigationDrawerItemIndentationLevel } from "@twenty-modules/ui/navigation/navigation-drawer/components/NavigationDrawerItem"
...
const useSettingsNavigationItems = (): SettingsNavigationSection[] => {
  ...
  const isAdminEnabled = (currentUser?.canImpersonate || currentUser?.canAccessFullAdminPanel) ?? false
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          isHidden: !isBillingEnabled || !permissionMap[SettingPermissionType.WORKSPACE],
        },
        {
          label: t`Data model`,
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          Icon: IconFlask,
          isHidden: !labPublicFeatureFlags.length || !permissionMap[SettingPermissionType.WORKSPACE],
        },
        {
          label: t`Releases`,
