import { SettingsCounter } from '@twenty-modules/settings/components/SettingsCounter';
import {
  StyledSettingsOptionCardContent,
  StyledSettingsOptionCardDescription,
  StyledSettingsOptionCardIcon,
  StyledSettingsOptionCardTitle,
} from '@twenty-modules/settings/components/SettingsOptions/SettingsOptionCardContentBase';
import { SettingsOptionIconCustomizer } from '@twenty-modules/settings/components/SettingsOptions/SettingsOptionIconCustomizer';
