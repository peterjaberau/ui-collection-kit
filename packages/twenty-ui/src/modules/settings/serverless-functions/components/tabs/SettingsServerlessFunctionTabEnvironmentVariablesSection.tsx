import { SettingsServerlessFunctionTabEnvironmentVariableTableRow } from '@twenty-modules/settings/serverless-functions/components/tabs/SettingsServerlessFunctionTabEnvironmentVariableTableRow';
