import { useUpdateOneDatabaseConnection } from '@twenty-modules/databases/hooks/useUpdateOneDatabaseConnection';
import { SaveAndCancelButtons } from '@twenty-modules/settings/components/SaveAndCancelButtons/SaveAndCancelButtons';
import { SettingsHeaderContainer } from '@twenty-modules/settings/components/SettingsHeaderContainer';
import { SettingsIntegrationDatabaseConnectionForm } from '@twenty-modules/settings/integrations/database-connection/components/SettingsIntegrationDatabaseConnectionForm';
import {
  formatValuesForUpdate,
  getEditionSchemaForForm,
  getFormDefaultValuesFromConnection,
} from '@twenty-modules/settings/integrations/database-connection/utils/editDatabaseConnection';
import { SettingsIntegration } from '@twenty-modules/settings/integrations/types/SettingsIntegration';
...
import { Breadcrumb } from '@twenty-modules/ui/navigation/bread-crumb/components/Breadcrumb';
