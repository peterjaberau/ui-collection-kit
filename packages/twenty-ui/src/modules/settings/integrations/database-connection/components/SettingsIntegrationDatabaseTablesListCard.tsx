...
import { useSyncRemoteTable } from '@twenty-modules/databases/hooks/useSyncRemoteTable';
import { useSyncRemoteTableSchemaChanges } from '@twenty-modules/databases/hooks/useSyncRemoteTableSchemaChanges';
import { useUnsyncRemoteTable } from '@twenty-modules/databases/hooks/useUnsyncRemoteTable';
import { SettingsListCard } from '@twenty-modules/settings/components/SettingsListCard';
import { SettingsIntegrationRemoteTableSchemaUpdate } from '@twenty-modules/settings/integrations/components/SettingsIntegrationRemoteTableSchemaUpdate';
import { SettingsIntegrationRemoteTableSyncStatusToggle } from '@twenty-modules/settings/integrations/components/SettingsIntegrationRemoteTableSyncStatusToggle';
import {
  DistantTableUpdate,
  RemoteTable,
  RemoteTableStatus,
