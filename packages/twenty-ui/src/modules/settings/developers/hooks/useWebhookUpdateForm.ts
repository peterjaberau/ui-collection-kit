...
import { WEBHOOK_EMPTY_OPERATION } from '@twenty-ui/front/pages/settings/developers/webhooks/constants/WebhookEmptyOperation';
import { WebhookOperationType } from '@twenty-ui/front/pages/settings/developers/webhooks/types/WebhookOperationsType';
import {
