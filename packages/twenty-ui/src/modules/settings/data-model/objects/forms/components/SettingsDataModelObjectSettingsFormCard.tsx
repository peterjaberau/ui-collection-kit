...
import { SettingsDataModelCardTitle } from '@twenty-modules/settings/data-model/components/SettingsDataModelCardTitle';
import { SettingsDataModelFieldPreviewCard } from '@twenty-modules/settings/data-model/fields/preview/components/SettingsDataModelFieldPreviewCard';
import { SettingsDataModelObjectSummary } from '@twenty-modules/settings/data-model/objects/components/SettingsDataModelObjectSummary';
import { SettingsDataModelObjectIdentifiersForm } from '@twenty-modules/settings/data-model/objects/forms/components/SettingsDataModelObjectIdentifiersForm';
