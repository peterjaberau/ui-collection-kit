...
import { numberFieldDefaultValueSchema } from '@twenty-modules/object-record/record-field/validation-schemas/numberFieldDefaultValueSchema';
import { Separator } from '@twenty-modules/settings/components/Separator';
import { SettingsOptionCardContentCounter } from '@twenty-modules/settings/components/SettingsOptions/SettingsOptionCardContentCounter';
...
import { DEFAULT_DECIMAL_VALUE } from '@twenty-ui/front/utils/format/number';
import { NUMBER_DATA_MODEL_SELECT_OPTIONS } from '@twenty-modules/settings/data-model/fields/forms/number/constants/NumberDataModelSelectOptions';
