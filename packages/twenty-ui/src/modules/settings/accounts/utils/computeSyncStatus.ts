import { CalendarChannelSyncStatus } from '@twenty-modules/accounts/types/CalendarChannel';
import { MessageChannelSyncStatus } from '@twenty-modules/accounts/types/MessageChannel';
