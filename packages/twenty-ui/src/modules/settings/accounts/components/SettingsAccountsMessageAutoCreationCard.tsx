import { MessageChannelContactAutoCreationPolicy } from '@twenty-modules/accounts/types/MessageChannel';
import { SettingsAccountsMessageAutoCreationIcon } from '@twenty-modules/settings/accounts/components/SettingsAccountsMessageAutoCreationIcon';
