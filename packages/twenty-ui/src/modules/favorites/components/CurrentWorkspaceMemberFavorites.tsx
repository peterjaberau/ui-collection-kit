import { FavoriteFolderNavigationDrawerItemDropdown } from '@twenty-modules/favorites/components/FavoriteFolderNavigationDrawerItemDropdown';
...
import { useDeleteFavoriteFolder } from '@twenty-modules/favorites/hooks/useDeleteFavoriteFolder';
import { useRenameFavoriteFolder } from '@twenty-modules/favorites/hooks/useRenameFavoriteFolder';
import { openFavoriteFolderIdsState } from '@twenty-modules/favorites/states/openFavoriteFolderIdsState';
import { isLocationMatchingFavorite } from '@twenty-modules/favorites/utils/isLocationMatchingFavorite';
import { ProcessedFavorite } from '@twenty-modules/favorites/utils/sortFavorites';
...
import { NavigationDrawerItemsCollapsableContainer } from '@twenty-modules/ui/navigation/navigation-drawer/components/NavigationDrawerItemsCollapsableContainer';
import { NavigationDrawerSubItem } from '@twenty-modules/ui/navigation/navigation-drawer/components/NavigationDrawerSubItem';
import { getNavigationSubItemLeftAdornment } from '@twenty-modules/ui/navigation/navigation-drawer/utils/getNavigationSubItemLeftAdornment';
