import { ActionOpenSidePanelPage } from '@twenty-modules/action-menu/actions/components/ActionOpenSidePanelPage';
import { RecordAgnosticActionsKeys } from '@twenty-modules/action-menu/actions/record-agnostic-actions/types/RecordAgnosticActionsKeys';
