...
export const ExportNoteActionSingleRecordAction = () => {
  ...
  const handleClick = async () => {
    ...
    const { exportBlockNoteEditorToPdf } = await import(
      '@twenty-modules/action-menu/actions/record-actions/single-record/utils/exportBlockNoteEditorToPdf'
    );
    ...
    //   '@twenty-modules/action-menu/actions/record-actions/single-record/utils/exportBlockNoteEditorToDocx'
    // );
