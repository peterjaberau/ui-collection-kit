...
import { ActivityList } from '@twenty-modules/activities/components/ActivityList';
...
import { EmailThreadPreview } from '@twenty-modules/activities/emails/components/EmailThreadPreview';
import { TIMELINE_THREADS_DEFAULT_PAGE_SIZE } from '@twenty-modules/activities/emails/constants/Messaging';
import { getTimelineThreadsFromCompanyId } from '@twenty-modules/activities/emails/graphql/queries/getTimelineThreadsFromCompanyId';
import { getTimelineThreadsFromPersonId } from '@twenty-modules/activities/emails/graphql/queries/getTimelineThreadsFromPersonId';
import { useCustomResolver } from '@twenty-modules/activities/hooks/useCustomResolver';
import { ActivityTargetableObject } from '@twenty-modules/activities/types/ActivityTargetableEntity';
import { CoreObjectNameSingular } from '@twenty-modules/object-metadata/types/CoreObjectNameSingular';
import { TimelineThread, TimelineThreadsWithTotal } from '@twenty-ui/front/generated/graphql';
import {
  AnimatedPlaceholder,
