...
import { useLinkedObjectObjectMetadataItem } from '@twenty-modules/activities/timeline-activities/hooks/useLinkedObjectObjectMetadataItem';
import { EventIconDynamicComponent } from '@twenty-modules/activities/timeline-activities/rows/components/EventIconDynamicComponent';
import { EventRowDynamicComponent } from '@twenty-modules/activities/timeline-activities/rows/components/EventRowDynamicComponent';
import { TimelineActivity } from '@twenty-modules/activities/timeline-activities/types/TimelineActivity';
import { getTimelineActivityAuthorFullName } from '@twenty-modules/activities/timeline-activities/utils/getTimelineActivityAuthorFullName';
