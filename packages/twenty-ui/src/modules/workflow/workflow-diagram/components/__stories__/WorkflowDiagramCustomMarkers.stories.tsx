...
import { WORKFLOW_VISUALIZER_EDGE_SUCCESS_CONFIGURATION } from '@twenty-modules/workflow/workflow-diagram/constants/WorkflowVisualizerEdgeSuccessConfiguration';
...
import { ReactflowDecorator } from '@twenty-ui/front/testing/decorators/ReactflowDecorator';
...
const meta: Meta = {
  title: 'Refactor Modules/Workflow/WorkflowDiagram/WorkflowDiagramCustomMarkers',
