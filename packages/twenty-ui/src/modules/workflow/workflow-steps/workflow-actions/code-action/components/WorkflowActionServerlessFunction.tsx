...
import { RightDrawerSkeletonLoader } from '@twenty-ui/front/loading/components/RightDrawerSkeletonLoader';
...
const WorkflowEditActionServerlessFunction = lazy(() =>
  import(
    '@twenty-modules/workflow/workflow-steps/workflow-actions/code-action/components/WorkflowEditActionServerlessFunction'
  ).then((module) => ({
...
const WorkflowReadonlyActionServerlessFunction = lazy(() =>
  import(
    '@twenty-modules/workflow/workflow-steps/workflow-actions/code-action/components/WorkflowReadonlyActionServerlessFunction'
  ).then((module) => ({
