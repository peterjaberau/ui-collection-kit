import { useUpdateCommandMenuPageInfo } from '@twenty-modules/command-menu/hooks/useUpdateCommandMenuPageInfo';
import { TitleInput } from '@twenty-modules/ui/input/components/TitleInput';
