...
import {
  ...
  StringFilter,
  UUIDFilter,
} from '@twenty-modules/object-record/graphql/types/RecordGqlOperationFilter';
import { isMatchingArrayFilter } from '@twenty-modules/object-record/record-filter/utils/isMatchingArrayFilter';
import { isMatchingBooleanFilter } from '@twenty-modules/object-record/record-filter/utils/isMatchingBooleanFilter';
import { isMatchingCurrencyFilter } from '@twenty-modules/object-record/record-filter/utils/isMatchingCurrencyFilter';
import { isMatchingDateFilter } from '@twenty-modules/object-record/record-filter/utils/isMatchingDateFilter';
import { isMatchingFloatFilter } from '@twenty-modules/object-record/record-filter/utils/isMatchingFloatFilter';
import { isMatchingMultiSelectFilter } from '@twenty-modules/object-record/record-filter/utils/isMatchingMultiSelectFilter';
import { isMatchingRatingFilter } from '@twenty-modules/object-record/record-filter/utils/isMatchingRatingFilter';
import { isMatchingRawJsonFilter } from '@twenty-modules/object-record/record-filter/utils/isMatchingRawJsonFilter';
import { isMatchingRichTextV2Filter } from '@twenty-modules/object-record/record-filter/utils/isMatchingRichTextV2Filter';
import { isMatchingSelectFilter } from '@twenty-modules/object-record/record-filter/utils/isMatchingSelectFilter';
import { isMatchingStringFilter } from '@twenty-modules/object-record/record-filter/utils/isMatchingStringFilter';
import { isMatchingUUIDFilter } from '@twenty-modules/object-record/record-filter/utils/isMatchingUUIDFilter';
