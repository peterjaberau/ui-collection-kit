...
import { RecordTitleCellSingleTextDisplayMode } from '@twenty-modules/object-record/record-title-cell/components/RecordTitleCellTextFieldDisplay';
import { RecordTitleFullNameFieldDisplay } from '@twenty-modules/object-record/record-title-cell/components/RecordTitleFullNameFieldDisplay';
