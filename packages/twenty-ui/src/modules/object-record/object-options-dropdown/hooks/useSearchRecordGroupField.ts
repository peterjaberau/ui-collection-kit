import { objectOptionsDropdownSearchInputComponentState } from '@twenty-modules/object-record/object-options-dropdown/states/objectOptionsDropdownSearchInputComponentState';
