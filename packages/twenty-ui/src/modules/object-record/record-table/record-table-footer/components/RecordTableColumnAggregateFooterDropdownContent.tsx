...
import { RecordTableColumnAggregateFooterDropdownSubmenuContent } from '@twenty-modules/object-record/record-table/record-table-footer/components/RecordTableColumnAggregateDropdownSubmenuContent';
...
import { RecordTableColumnAggregateFooterMenuContent } from '@twenty-modules/object-record/record-table/record-table-footer/components/RecordTableColumnAggregateFooterMenuContent';
...
import { DATE_AGGREGATE_OPERATION_OPTIONS } from '@twenty-modules/object-record/record-table/record-table-footer/constants/dateAggregateOperationOptions';
...
import { STANDARD_AGGREGATE_OPERATION_OPTIONS } from '@twenty-modules/object-record/record-table/record-table-footer/constants/standardAggregateOperationOptions';
import { getAvailableAggregateOperationsForFieldMetadataType } from '@twenty-modules/object-record/record-table/record-table-footer/utils/getAvailableAggregateOperationsForFieldMetadataType';
