import { DateInput } from '@twenty-modules/ui/field/input/components/DateInput';

import { FieldInputEvent } from '@twenty-modules/object-record/record-field/meta-types/input/components/NumberFieldInput';
