import { ActivityRichTextEditor } from '@twenty-modules/activities/components/ActivityRichTextEditor';
import { ActivityTargetableObject } from '@twenty-modules/activities/types/ActivityTargetableEntity';
import { useRichTextCommandMenu } from '@twenty-modules/command-menu/hooks/useRichTextCommandMenu';
