...
import { NumberFieldDisplay } from '@twenty-modules/object-record/record-field/meta-types/display/components/NumberFieldDisplay';
...
const meta: Meta = {
  title: 'Refactor UI/Data/Field/Display/NumberFieldDisplay',
  decorators: [
