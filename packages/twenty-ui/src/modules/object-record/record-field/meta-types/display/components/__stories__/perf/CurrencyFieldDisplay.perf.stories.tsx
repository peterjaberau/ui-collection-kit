...
import { CurrencyFieldDisplay } from '@twenty-modules/object-record/record-field/meta-types/display/components/CurrencyFieldDisplay';
...
const meta: Meta = {
  title: 'Refactor UI/Data/Field/Display/CurrencyFieldDisplay',
  decorators: [
