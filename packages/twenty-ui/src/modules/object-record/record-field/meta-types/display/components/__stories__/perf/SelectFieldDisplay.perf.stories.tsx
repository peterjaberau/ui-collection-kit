...
import { SelectFieldDisplay } from '@twenty-modules/object-record/record-field/meta-types/display/components/SelectFieldDisplay';
...
const meta: Meta = {
  title: 'Refactor UI/Data/Field/Display/SelectFieldDisplay',
  decorators: [
