...
import { TextFieldDisplay } from '@twenty-modules/object-record/record-field/meta-types/display/components/TextFieldDisplay';
...
const meta: Meta = {
  title: 'Refactor UI/Data/Field/Display/TextFieldDisplay',
  decorators: [
