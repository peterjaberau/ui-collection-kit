...
import { useRecordIdsFromFindManyCacheRootQuery } from '@twenty-modules/object-record/record-show/hooks/useRecordIdsFromFindManyCacheRootQuery';
import { AppPath } from '@twenty-modules/types/AppPath';
import { useQueryVariablesFromActiveFieldsOfViewOrDefaultView } from '@twenty-modules/views/hooks/useQueryVariablesFromActiveFieldsOfViewOrDefaultView';
