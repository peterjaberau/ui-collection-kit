...
import { BASE_RECORD_LAYOUT } from '@twenty-modules/object-record/record-show/constants/BaseRecordLayout';
...
import { SingleTabProps } from '@twenty-modules/ui/layout/tab/components/TabList';
