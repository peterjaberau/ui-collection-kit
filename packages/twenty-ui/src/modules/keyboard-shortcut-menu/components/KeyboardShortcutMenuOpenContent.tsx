...
import { KEYBOARD_SHORTCUTS_GENERAL } from '@twenty-modules/keyboard-shortcut-menu/constants/KeyboardShortcutsGeneral';
import { KEYBOARD_SHORTCUTS_TABLE } from '@twenty-modules/keyboard-shortcut-menu/constants/KeyboardShortcutsTable';
