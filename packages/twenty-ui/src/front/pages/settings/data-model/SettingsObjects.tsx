import { useDeleteOneObjectMetadataItem } from '@twenty-modules/object-metadata/hooks/useDeleteOneObjectMetadataItem';
...
import { useCombinedGetTotalCount } from '@twenty-modules/object-record/multiple-objects/hooks/useCombinedGetTotalCount';
import { SettingsPageContainer } from '@twenty-modules/settings/components/SettingsPageContainer';
import {
  SettingsObjectMetadataItemTableRow,
  StyledObjectTableRow,
} from '@twenty-modules/settings/data-model/object-details/components/SettingsObjectItemTableRow';
import { SettingsObjectCoverImage } from '@twenty-modules/settings/data-model/objects/components/SettingsObjectCoverImage';
import { SettingsObjectInactiveMenuDropDown } from '@twenty-modules/settings/data-model/objects/components/SettingsObjectInactiveMenuDropDown';
...
import { SortableTableHeader } from '@twenty-modules/ui/layout/table/components/SortableTableHeader';
...
import { TableSection } from '@twenty-modules/ui/layout/table/components/TableSection';
import { useSortedArray } from '@twenty-modules/ui/layout/table/hooks/useSortedArray';
import { useTheme } from '@emotion/react';
import styled from '@emotion/styled';
import { Trans, useLingui } from '@lingui/react/macro';
import { isNonEmptyArray } from '@sniptt/guards';
import { useMemo, useState } from 'react';
import { GET_SETTINGS_OBJECT_TABLE_METADATA } from '@twenty-ui/front/pages/settings/data-model/constants/SettingsObjectTableMetadata';
import { SettingsObjectTableItem } from '@twenty-ui/front/pages/settings/data-model/types/SettingsObjectTableItem';
