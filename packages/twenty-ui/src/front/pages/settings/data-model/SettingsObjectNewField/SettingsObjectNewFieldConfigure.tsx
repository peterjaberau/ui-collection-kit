import { useCreateOneRelationMetadataItem } from '@twenty-modules/object-metadata/hooks/useCreateOneRelationMetadataItem';
import { useFieldMetadataItem } from '@twenty-modules/object-metadata/hooks/useFieldMetadataItem';
...
import { FIELD_NAME_MAXIMUM_LENGTH } from '@twenty-modules/settings/data-model/constants/FieldNameMaximumLength';
import { SettingsDataModelFieldDescriptionForm } from '@twenty-modules/settings/data-model/fields/forms/components/SettingsDataModelFieldDescriptionForm';
import { SettingsDataModelFieldIconLabelForm } from '@twenty-modules/settings/data-model/fields/forms/components/SettingsDataModelFieldIconLabelForm';
import { SettingsDataModelFieldSettingsFormCard } from '@twenty-modules/settings/data-model/fields/forms/components/SettingsDataModelFieldSettingsFormCard';
import { settingsFieldFormSchema } from '@twenty-modules/settings/data-model/fields/forms/validation-schemas/settingsFieldFormSchema';
...
import { DEFAULT_ICONS_BY_FIELD_TYPE } from '@twenty-ui/front/pages/settings/data-model/constants/DefaultIconsByFieldType';
import { computeMetadataNameFromLabel } from '@twenty-ui/front/pages/settings/data-model/utils/compute-metadata-name-from-label.utils';
