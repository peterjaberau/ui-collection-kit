...
import { SettingsCustomDomain } from '@twenty-ui/front/pages/settings/workspace/SettingsCustomDomain';
import { SettingsSubdomain } from '@twenty-ui/front/pages/settings/workspace/SettingsSubdomain';
