...
import { SettingsAccountsCalendars } from '@twenty-ui/front/pages/settings/accounts/SettingsAccountsCalendars';
...
const meta: Meta<PageDecoratorArgs> = {
  title: 'Refactor Pages/Settings/Accounts/SettingsAccountsCalendars',
