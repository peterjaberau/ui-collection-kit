...
import { LeftPanelSkeletonLoader } from '@twenty-ui/front/loading/components/LeftPanelSkeletonLoader';
import { RightPanelSkeletonLoader } from '@twenty-ui/front/loading/components/RightPanelSkeletonLoader';
