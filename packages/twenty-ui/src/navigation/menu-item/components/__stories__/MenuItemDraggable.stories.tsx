...
import { CatalogDecorator, CatalogDimension, CatalogOptions, ComponentDecorator } from "../../../../testing"
      ...
      dimensions: [
        {
          ...
          labels: (isDragDisabled: boolean) => (isDragDisabled ? "Without drag icon" : "With drag icon"),
        },
        {
          name: "accents",
