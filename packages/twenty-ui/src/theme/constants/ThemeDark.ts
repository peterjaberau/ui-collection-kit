import { ADAPTIVE_COLORS_DARK } from '../../theme/constants/AdaptiveColorsDark';
import { BLUR_DARK } from '../../theme/constants/BlurDark';
import { ILLUSTRATION_ICON_DARK } from '../../theme/constants/IllustrationIconDark';
