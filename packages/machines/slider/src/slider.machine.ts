...
import { raf, setElementValue, trackFormControl, trackPointerMove, trackElementRect } from "@ui-collection-kit/dom-query"
import type { Size } from "@ui-collection-kit/types"
import {
  clampValue,
  getValuePercent,
  getValueRanges,
