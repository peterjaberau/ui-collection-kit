import type { Params, Scope } from "@ui-collection-kit/core"
import { dispatchInputValueEvent, getRelativePoint, queryAll } from "@ui-collection-kit/dom-query"
import type { Point } from "@ui-collection-kit/types"
import { getPercentValue } from "@ui-collection-kit/utils"
