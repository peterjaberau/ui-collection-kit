import type { Params } from "@ui-collection-kit/core"
import { getEventTarget, getWindow } from "@ui-collection-kit/dom-query"
import { isValidFileSize, isValidFileType, type FileError } from "@ui-collection-kit/file-utils"
