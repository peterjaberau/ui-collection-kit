...
export const TimePickerRootProvider = forwardRef<HTMLDivElement, TimePickerRootProviderProps>((props, ref) => {
  const [presenceProps, timePickerProps] = splitPresenceProps(props)
  const [{ value: timePicker }, localProps] = createSplitProps<RootProviderProps>()(timePickerProps, ['value'])
